        ...
        <div class="flow-root p-4">  
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs" id="productosCreados">
              <div class="w-full overflow-x-auto">
                <div class="flex filtroCategoria mb-2" id="filtroCategoria"></div>
                      ...
                      <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-2 py-px text-center">
                          @foreach($data->details as $index => $detail)
                            ...
                            <span class="p-2 rounded shadow borderjz-display-middle text-purple-600 dark:gray-300 mb-2">
                        ...
                        <td class="px-2 py-px text-center">
                          <div class="space-x-4 text-sm">
                            ...
                            <button
                              class="justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                              onclick="destroyCombo('{{ $data->id }}', '{{ $data->image }}', '{{ $data->tipo }}')"
                              aria-label="Delete"
                            >
                              <svg
                                class="w-5 h-5"
                  ...
                  <form id="addProductform" action="{{ route('productosCreate') }}" class="group" method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div x-data="{ selectedAccordionItem: 'one' }" class="w-full divide-y divide-outline overflow-hidden rounded-sm" id="simple_form">
                              <div class="flex justify-between">
                                  ...
                                  <p class="text-xl font-bold text-gray-500 p-2 mb-3 hidden" id="servicio_basic_title">Formulario Básico de Servicios</p>
                                  <p class="text-xl font-bold text-gray-500 p-2 mb-3" id="combo_basic_title">Formulario Básico de Combos</p>
                                  ...
                                  <div x-cloak x-show="selectedAccordionItem === 'one'" id="accordionItemOne" role="region" aria-labelledby="controlsAccordionItemOne" x-collapse>
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4">
                                            ...
                                            <label id="servicioTipoLabel" onclick="selectServicio()" class="cursor-pointer relative flex items-center gap-4 rounded-radius bg-surface-alt p-2 hover:scale-105 transition-transform text-on-surface dark:text-on-surface-dark dark:bg-surface-dark-alt has-checked:border-primary has-checked:bg-primary/5 has-checked:text-on-surface-strong has-checked:border has-focus:outline-2 has-focus:outline-offset-2 has-focus:outline-primary dark:has-checked:border-primary-dark dark:has-checked:text-on-surface-dark-strong dark:has-checked:bg-primary-dark/5 dark:has-focus:outline-primary-dark border border-outline dark:border-outline-dark">
                                                <input type="radio" id="tipo_servicio" aria-describedby="servicio" class="sr-only peer" name="tipo" value="servicio">
                                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16" fill="#9333ea" class="dark:text-gray-300 peer-checked:visible invisible w-5 h-5 shrink-0">
                                                    <path fill-rule="evenodd" d="M12.416 3.376a.75.75 0 0 1 .208 1.04l-5 7.5a.75.75 0 0 1-1.154.114l-3-3a.75.75 0 0 1 1.06-1.06l2.353 2.353 4.493-6.74a.75.75 0 0 1 1.04-.207Z" clip-rule="evenodd">
                                                </svg>
                                            ...
                                            <label id="combooTipoLabel" onclick="selectCombo()" class="cursor-pointer relative flex items-center gap-4 rounded-radius bg-surface-alt p-2 hover:scale-105 transition-transform text-on-surface dark:text-on-surface-dark dark:bg-surface-dark-alt has-checked:border-primary has-checked:bg-primary/5 has-checked:text-on-surface-strong has-checked:border has-focus:outline-2 has-focus:outline-offset-2 has-focus:outline-primary dark:has-checked:border-primary-dark dark:has-checked:text-on-surface-dark-strong dark:has-checked:bg-primary-dark/5 dark:has-focus:outline-primary-dark border border-outline dark:border-outline-dark">
                                                <input type="radio" id="tipo_combo" aria-describedby="combo" class="sr-only peer" name="tipo" value="combo" checked>
                                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16" fill="#9333ea" class="dark:text-gray-300 peer-checked:visible invisible w-5 h-5 shrink-0">
                                                    <path fill-rule="evenodd" d="M12.416 3.376a.75.75 0 0 1 .208 1.04l-5 7.5a.75.75 0 0 1-1.154.114l-3-3a.75.75 0 0 1 1.06-1.06l2.353 2.353 4.493-6.74a.75.75 0 0 1 1.04-.207Z" clip-rule="evenodd">
                                                </svg>
                                                  ...
                                                  <template x-for="(item, index) in dataz" :key="index" x-transition>
                                                      <div>
                                                          <div class="p-2 text-sm sm:text-base text-pretty mb-2 grid grid-cols-4 sm-grid-cols-3">
                                                            ...
                                                            <div class="text-sm p-2">
                                                                <div class="inline-block relative w-full" x-id="['comboProductEdit']">
                                                                      ...
                                                                      <select class="cursor-pointer border rounded border-slate-200 p-2 flex flex-col justify-center w-full items-center 
                                                                          ...
                                                                          :id="$id('comboProductEdit')"
                                                                          :name="$id('comboProductEdit')">
                                                            ...
                                                            <div class="text-sm p-2 jz-center" x-id="['comboCantEdit']">
                      ...
                      <div x-data="{ selectedAccordionItem: 'one' }" class="w-full divide-y divide-outline overflow-hidden rounded-sm hidden" id="advanced_form">
                            ...
                            <div class="flex justify-between">
                                ...
                                <p class="text-xl font-bold text-gray-500 p-2 mb-3 hidden" id="servicio_advanced_title">Formulario Avanzado de Servicios</p>
                                <p class="text-xl font-bold text-gray-500 p-2 mb-3" id="combo_advanced_title">Formulario Avanzado de Combos</p>
                                  <div class="modal-close cursor-pointer z-50 flex flex-row" onclick="modalClose('addProduct')">
                                    <svg class="fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 18 18">
                                        <path
                      ...
                      <form id="editProductform" action="{{ route('productosEdit') }}" class="group" method="POST" enctype="multipart/form-data" novalidate>
                            ...
                            <div x-data="{ selectedAccordionItem: 'one' }" class="w-full divide-y divide-outline overflow-hidden rounded-sm" id="simple_form_edit">
                              <div class="flex justify-between items-center pb-3 dark:bg-gray-800">
                                <p class="text-xl font-bold text-gray-500 p-2 mb-3" id="simple_title_edit">Formulario Básico de Edición de Productos</p>
                                <p class="text-xl font-bold text-gray-500 p-2 mb-3 hidden" id="servicio_basic_title_edit">Formulario Básico de Edición de Servicios</p>
                                ...
                                <div class="modal-close cursor-pointer z-50" onclick="location.href='combos'">
                                  <svg class="fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 18 18">
                                    <path
                                      d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z">
                          ...
                          <div x-data="{ selectedAccordionItem: 'one' }" class="w-full divide-y divide-outline overflow-hidden rounded-sm hidden" id="advanced_form_edit">
                              <div class="flex justify-between items-center pb-3 dark:bg-gray-800">
                                ...
                                <p class="text-xl font-bold text-gray-500 p-2 mb-3 hidden" id="servicio_advanced_title_edit">Formulario Avanzado de Edición de Servicios</p>
                                <p class="text-xl font-bold text-gray-500 p-2 mb-3" id="combo_advanced_title_edit">Formulario Avanzado de Edición de Combos</p>
...
function filtrarCategoria(){
        ...
        filtroCategoria.setAttribute("style", "width: 350px;")
        ...
        axios.post('findCatCombo', {
                    ...
                    .then(function (response) {
                      if (response.data == 'no'){
                        Swal.fire({
                                  title: 'Error!',
                                  text: 'Categoría no asignada a algún combo.',
                                  icon: 'error',
                                  timer: 2000,
                      ...
                      if(response.data !== 'no' && response.data[0] !== ''){
                        window.location.href = 'combos?q=' + idCat
                        return
                      }
        ...
        if(searchQ !== ''){
          axios.post('searchNameCombo', {
                    ...
                    .then(function (response) {
                      ...
                      if(response.data !== 'no' && response.data[0] !== ''){
                        window.location.href = 'combos?q=' + searchQ
                        return
                      }
      ...
      function filterCombos(){
        var productosCreados = document.getElementById('productosCreados')
        ...
        if(category_id == '' || image == '' || description == '' || minimo == '' || maximo == '' || venta_negativo == '' || codigo_unspsc == '' || minimo == '' || maximo == ''){
          ...
          if(image == 'http://localhost/factuvalente/public/uploads/products'){  
              ...
              if(tipo == 'combo'){
                ...
                // document.getElementById("costoInicial").value = 1
                var barcode_edit =  document.getElementById("barcode_edit").value
                document.getElementById("barcode2_edit").value = document.getElementById("barcode_edit").value
                var barcode2SpanEdit =  document.getElementById("barcode2SpanEdit")
                var barcode2DivEdit =  document.getElementById("barcode2DivEdit")
                var barcodeSpanEdit =  document.getElementById("barcodeSpanEdit")
                var divNombreUnidadEdit =  document.getElementById("divNombreUnidadEdit")
                    ...
                    .then(function (response) {
                              ...
                              //     }
                                  ...
                                  response.data.forEach(function(element){
                                    document.getElementById("putCombos").innerHTML += 
                                               '<div id="comboProd'+i+'">'+
                                                   '<div class="p-2 text-sm sm:text-base text-pretty mb-2 grid grid-cols-4 sm-grid-cols-3">'+
                                                     '<div class="text-sm p-2 jz-center jz-hide-small mt-1">'+
                                                           '<button type="button"class="p-2 rounded shadow borderjz-display-middle text-purple-600 dark:gray-300 mb-2">'+
                                                             '<i class="fa fa-tag fa-2x" aria-hidden="true"></i>'+
                                                           '</button>'+
                                                     '</div>'+
                                                     '<div class="text-sm p-2">'+
                                                         '<div class="inline-block relative w-full text-center">'+
                                                               '<span class="dark:text-gray-300">Producto</span>'+
                                                               '<div id="placeHere" class="mt-1"></div>'+
                                                         '</div>'+
                                                     '</div>'+
                                                     '<div class="text-sm p-2">'+
                                                         '<div class="inline-block relative w-full text-center">'+
                                                               '<span class="dark:text-gray-300">Cantidad</span>'+
                                                               '<div id="cantHere" class="mt-1"></div>'+
                                                         '</div>'+
                                                     '</div>'+
                                                     '<div class="text-sm p-2 mt-1">'+
                                                             '<button type="button" class="p-2 rounded shadow borderjz-display-middle text-purple-600 dark:gray-300 mb-2" onclick="destroyComboProd('+element.id+', '+i+')">'+
                                                                   '<i class="fa fa-trash fa-2x" aria-hidden="true"></i>'+
                                                             '</button>'+
                                                     '</div>'+
                                                   '</div>'+
                                    ...
                                    let list = document.getElementById("placeHere")
                                    let cant = document.getElementById("cantHere")

                                    list.id = 'prod'+i
                                    cant.id = 'cant'+i

                                    var prodCombo = document.createElement("SPAN");
                                    var cantCombo = document.createElement("SPAN");

                                    var elProd = document.createTextNode(element.title);
                                    var elCant = document.createTextNode(element.qty);

                                    prodCombo.id = 'prodCombo'+i
                                    prodCombo.classList.add("bg-purple-600")
                                    prodCombo.classList.add("p-1")
                                    prodCombo.classList.add("rounded")
                                    prodCombo.classList.add("text-white")
                                    cantCombo.id = 'cantCombo'+i
                                    cantCombo.classList.add("bg-purple-600")
                                    cantCombo.classList.add("p-1")
                                    cantCombo.classList.add("rounded")
                                    cantCombo.classList.add("text-white")

                                    prodCombo.appendChild(elProd);
                                    cantCombo.appendChild(elCant);

                                    list.appendChild(prodCombo);
                                    cant.appendChild(cantCombo);
      ...
      window.send_val_combo = 0
      function destroyComboProd(id, i){
        console.log(id, 'pooooo')
        window.send_val_combo = 1
        
        axios.post('removeComboProduct', {
            id: id,
            i: i
            
          })
          .then(function (response) {
            if(response.data.details.combosDetail.is_active == 2){
              var comboProd = document.getElementById('comboProd'+ response.data.details.i)
              comboProd.classList.add("hidden")
      ...
      function updatePrecioImpuestoEdit(){
        console.log('da')
        var precioFinalEdit = document.getElementById('sell_price_edit').value
        var precioBaseEdit = document.getElementById('precio_base_edit').value
        var precioFinalIdEdit = document.getElementById('sell_price_edit')
        var precioBaseIdEdit = document.getElementById('precio_base_edit')
        ...
        if(precioBaseEdit == '' && precioFinalEdit == ''){
          ...
          console.log('uno')
            ...
            document.getElementById('sell_price_edit').value = exePrecioFinalEdit
      ...
      function updatePrecioBase(){
        var precioFinal = document.getElementById('sell_price_edit').value
        var precioBase = document.getElementById('precio_base_edit').value
        var precioFinalId = document.getElementById('sell_price_edit')
        var precioBaseId = document.getElementById('precio_base_edit')
            ...
            case 'IVA (19.00%)':
              ...
              break;
                ...
                if(impuesto !== 0 && precioBase !== ''){
                  var exePrecioFinal =  (precioBase * imp) + parseInt(precioBase)
                  document.getElementById('sell_price_edit').value = exePrecioFinal
                  precioFinalId.classList.add("bg-input")
                  precioBaseId.classList.add("bg-input")
                }
      ...
      function updatePrecioFinalEdit(){
        ...
        switch(impuestoEdit) {
          ...
          if(impuestoEdit !== 0 && precioFinalEdit !== ''){
            ...
            document.getElementById('precio_base_edit').value = exePrecioBaseEdit
            precioBaseIdEdit.classList.add("bg-input")
            precioFinalIdEdit.classList.add("bg-input")
          }
          if(precioFinalEdit == '' && impuestoEdit !== 0){
      ...
      function submitAddProd(){
        ...
        function destroyCombo(id, imagen, tipo) {
            Swal.fire({
              title: '¿Está seguro?',
                    ...
                    axios.post('destroyCombo', {
                      ...
                      .then(function (response) {
                        ...
                        if(response.data == 'si'){
                            ...
                            window.location.href = "{{ route('combos')}}" 
                            return
                        }
                        console.log('no')
                    ...
                    axios.post('desactivarProducto', {
                      ...
                      .then(function (response) {
                        ...
                        if(response.data == 'si'){
                            Swal.fire({
                                title: 'Desactivado!',
                                text: 'Combo desactivado correctamente.',
                                icon: 'success',
                                timer: 1000,
                                showConfirmButton: false,
                            });
                    ...
                    axios.post('desactivarProducto', {
                      ...
                      .then(function (response) {
                        ...
                        if(response.data == 'si'){
                            Swal.fire({
                                title: 'Activado!',
                                text: 'Combo activado correctamente.',
                                icon: 'success',
                                timer: 1000,
                                showConfirmButton: false,
                            });
      ...
      function selectBarcode2Edit(){
          document.getElementById('barcode_edit').value = document.getElementById('barcode2_edit').value
      }

      function submitEditProd(){
            
            if(send_val_combo == 1){
                document.getElementById('send_val_combo').innerHTML = 
              '<input id="send_val_combo" name="send_val_combo" type="text" class="hidden" value="pajuo">'
            }
